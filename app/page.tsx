    ...
    <div className="min-h-screen bg-neutral-50 text-neutral-900">
      <nav className="sticky top-0 z-10 bg-white/90 backdrop-blur border-b border-neutral-200">
        <div className="max-w-5xl mx-auto px-5 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link href="/signup" className="bg-neutral-900 text-white text-sm px-4 py-2 rounded-lg hover:bg-neutral-700 transition-colors">Start free</Link>
          </div>
        ...
        {menuOpen && (
          <div className="md:hidden border-t border-neutral-100 bg-white px-5 py-4 space-y-3">
            ...
            <Link href="/signup" className="block text-center bg-neutral-900 text-white text-sm px-4 py-2.5 rounded-lg mt-2">Start free</Link>
          </div>
        )}
      </nav>
      ...
      <section className="max-w-5xl mx-auto px-5 pt-14 pb-12 text-center">
        ...
        <div className="flex items-center justify-center gap-6 sm:gap-10 border-t border-neutral-200 pt-8 flex-wrap">
          {[['~90%', 'Parity with real research'], ['< 10 min', 'First insight'], ['$99/mo', 'vs. $8,000+ tools']].map(([num, label]) => (
      ...
      <section id="pricing" className="max-w-5xl mx-auto px-5 py-12">
        ...
        <p className="text-sm text-neutral-500 mb-8 font-light">Start free. Upgrade when it is earning its keep.</p>
