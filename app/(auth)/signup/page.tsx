        ...
        <div className="bg-white border border-neutral-200 rounded-2xl p-8">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <input type="text" value={fullName} onChange={e => setFullName(e.target.value)} required placeholder="Maya Chen"
            ...
            <p className="text-xs text-neutral-400 text-center leading-relaxed">
              By creating an account you agree to our <Link href="/terms" className="underline hover:text-neutral-700">Terms</Link> and <Link href="/privacy" className="underline hover:text-neutral-700">Privacy Policy</Link>
            </p>
          </form>
        </div>
