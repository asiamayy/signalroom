...
function ReferenceEvidence({ value, label, detail }: { value: number; label: string; detail: string }) {
  return <div className="rounded-xl bg-[#FCF9F8] p-3 text-center sm:p-4"><p className="mb-1 text-2xl" style={{ fontFamily: HOME_FONT_DISPLAY }}>{value}</p><p className="text-[8px] font-bold uppercase tracking-tighter text-[#18281C]/70">{label}</p><p className="text-[7px] text-[#6B7280]">{detail}</p></div>
}
