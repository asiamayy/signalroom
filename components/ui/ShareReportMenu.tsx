...
export function ShareReportMenu({ reportId, title, canSlack }: { reportId: string; title: string; canSlack: boolean }) {
  ...
  const bubble = 'absolute flex h-10 w-10 items-center justify-center rounded-full border border-[#c3c8c3]/70 bg-white text-[#18281c] shadow-md transition-all hover:-translate-y-1 hover:bg-[#18281c] hover:text-white'
